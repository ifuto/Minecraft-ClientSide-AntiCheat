...
// minimal SHA256 impl - public domain (adapted from https://github.com/B-Con/crypto-algorithms sha256.c)
namespace {
...
uint64_t SHA256::hash64_trunc(const std::string& data) {
    // lowercased input expected? caller should lower.
